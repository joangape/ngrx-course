...
export interface CoursesState extends EntityState<Course> { allCoursesLoaded: boolean }
...
export const coursesReducer = createReducer(
  initialCoursesState,
  on(
    CourseActions.allCoursesLoaded, (state, action) => adapter.setAll(action.courses, { ...state, allCoursesLoaded: true })
  ),
